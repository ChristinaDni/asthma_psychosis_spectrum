...
using "\dir\revision_03_07_25\prs\results\asthma_validation_prspc.dta", replace

*This bit of script updated to add AUC estimate for each model

foreach exposure in prspc1 {
	local i=0
...
using "\dir\revision_03_07_25\prs\results\asthma_association_prspc.dta", replace
