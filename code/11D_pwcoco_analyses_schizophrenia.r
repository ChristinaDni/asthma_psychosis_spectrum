...
data1<- read.table("topregions_asthma_schizophrenia.txt", sep="\t", header=T)
data2<- read.table("topregions_scz_asthma.txt", sep="\t", header=T)
...
A_trait <- list.files(path = "/dir/revision_03_07_25/pwcoco/trait/data/schizophrenia/trait1", pattern=pattern, recursive = TRUE)
print(A_trait)

B_trait<- list.files(path = "/dir/revision_03_07_25/pwcoco/trait/data/schizophrenia/trait2", pattern=pattern, recursive = TRUE)
print(B_trait)

#Assign the full directory so that pwcoco can work 
A_trait_dir<- paste0("/dir/revision_03_07_25/pwcoco/trait/data/schizophrenia/trait1/", A_trait)
B_trait_dir<- paste0("/dir/revision_03_07_25/pwcoco/trait/data/schizophrenia/trait2/", B_trait)
...
out_cmd<- paste("--out", paste0("/dir/revision_03_07_25/pwcoco/trait/results/asthma_schizophrenia"))
print(out_cmd)
