...
mol_trait <- list.files(path = "/dir/revision_03_07_25/pwcoco/tissue/data/metabrain/clean", pattern=pattern, recursive = TRUE)
print(mol_trait)

#Assign the full directory so that pwcoco can work 
mol_trait_dir<- paste0("/dir/revision_03_07_25/pwcoco/tissue/data/metabrain/clean/", mol_trait)
...
out_cmd<- paste("--out", paste0("/dir/revision_03_07_25/pwcoco/tissue/results/metabrain"))
print(out_cmd)
